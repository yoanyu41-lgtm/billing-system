...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ __('app.supplier_subtitle') }}</p>
        </div>
    ...
    <div class="mb-6 bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <form method="GET" action="{{ route('admin.suppliers.index') }}" class="flex flex-col md:flex-row gap-3">
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input 
                        ...
                        placeholder="{{ app()->getLocale() === 'km' ? 'ស្វែងរកតាមឈ្មោះ, អ៊ីមែល, ឬ អាសយដ្ឋាន...' : 'Search by name, email, or address...' }}"
                    >
            ...
            <div class="flex gap-2">
                ...
                @if(request('search'))
                    <a href="{{ route('admin.suppliers.index') }}" class="inline-flex items-center px-4 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
