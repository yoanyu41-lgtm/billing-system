...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
        ...
        <div class="flex flex-nowrap items-center gap-1.5 sm:gap-2 shrink-0 overflow-x-auto max-w-full">
            ...
            <a href="{{ route('installments.clearance-index') }}" class="inline-flex items-center gap-1.5 bg-amber-50 hover:bg-amber-100/80 text-amber-700 font-semibold text-xs px-3 py-2 rounded-xl border border-amber-200 shadow-sm transition whitespace-nowrap shrink-0">
