        ...
        <div id="creditCardContainer" class="hidden rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50/50 p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="col-span-2 md:col-span-1">
                    @php $cardProcessingFeePercent = \App\Models\Setting::where('key', 'card_gateway_fee_percent')->value('value') ?? (\App\Models\Setting::where('key', 'card_processing_fee')->value('value') ?? '3.00'); @endphp
